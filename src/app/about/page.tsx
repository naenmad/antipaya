                ...
                <section className="py-20 bg-white">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">{t('about.vision.title')}</h2>
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('about.philosophy.modular.title')}</h3>
                                <p className="text-gray-600 mb-6">
                                    {t('about.philosophy.modular.description')}
                                </p>
                                <ul className="space-y-2 text-sm text-gray-500">
                                    <li>• {t('about.philosophy.modular.points.reusable')}</li>
                                    <li>• {t('about.philosophy.modular.points.clean')}</li>
                                    <li>• {t('about.philosophy.modular.points.scalable')}</li>
                                    <li>• {t('about.philosophy.modular.points.flexible')}</li>
                                </ul>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('about.philosophy.scalable.title')}</h3>
                                <p className="text-gray-600 mb-6">
                                    {t('about.philosophy.scalable.description')}
                                </p>
                                <ul className="space-y-2 text-sm text-gray-500">
                                    <li>• {t('about.philosophy.scalable.points.performance')}</li>
                                    <li>• {t('about.philosophy.scalable.points.cloud')}</li>
                                    <li>• {t('about.philosophy.scalable.points.loadBalancing')}</li>
                                    <li>• {t('about.philosophy.scalable.points.futureProof')}</li>
                                </ul>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('about.philosophy.soulful.title')}</h3>
                                <p className="text-gray-600 mb-6">
                                    {t('about.philosophy.soulful.description')}
                                </p>
                                <ul className="space-y-2 text-sm text-gray-500">
                                    <li>• {t('about.philosophy.soulful.points.userCentered')}</li>
                                    <li>• {t('about.philosophy.soulful.points.meaningful')}</li>
                                    <li>• {t('about.philosophy.soulful.points.emotional')}</li>
                                    <li>• {t('about.philosophy.soulful.points.purposeDriven')}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
